    ...
    <nav class="navbar navbar-expand-lg mb-3">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbar-content">
            <ul class="navbar-nav mr-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="nav-link @if (Request::segment(1) === 'index') active @endif" aria-current="page"
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="{{ route('product') }}">Cloud Printer</a></li>
                        <li class="dropend">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="{{ route('locale', ['uz']) }}" class="dropdown-item">UZ</a></li>
                        <li><a href="{{ route('locale', ['en']) }}" class="dropdown-item">EN</a></li>
                        <li><a href="{{ route('locale', ['ru']) }}" class="dropdown-item">RU</a></li>
                    </ul>
                </li>
