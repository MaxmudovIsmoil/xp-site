                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            @if(env('TELEGRAM_LINK') != '')
                                <div class="mb-2">
                                    <a href="{{ env('TELEGRAM_LINK') }}" class="contact-icon">
                                        <span><i class="fa-brands fa-telegram me-2"></i></span> Telegram
                                    </a>
                                </div>
                            @endif
                            @if(env('TELEGRAM_LINK') != '')
                                <div class="mb-2">
                                    <a href="{{ env('INSTAGRAM_LINK') }}" class="contact-icon">
                                        <span><i class="fa-brands fa-instagram me-2"></i></span> Instagram
                                    </a>
                                </div>
                            @endif
                            @if(env('FACEBOOK_LINK') != '')
                                <div class="mb-2">
                                    <a href="{{ env('FACEBOOK_LINK') }}" class="contact-icon">
