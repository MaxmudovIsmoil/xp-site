...
{{--                                </div>--}}
                ...
                <div class="col-sm-4 col-md-4 col-lg-6 col-xl-4 col-xxl-5">
                    <div class="pro_info">
                        <div class="h3 title">{{ $product->model }}</div>
                        <div class="description key">
                            @foreach($product->product_detail as $pd)
                                <dl class="amount clearfix">
                                    <dt class="metatit">{{ $pd->language[0]->key }}</dt>
                        ...
                        <div class="card">
                            ...
                            @for ($i = 0; $i < 2; $i++)
                                <a href="1" class="recently-products">
                                    <img src="{{ asset('client/img/products/1.jpg') }}" class="card-img-top"
                                        alt="">
                                    <div class="card-body">
