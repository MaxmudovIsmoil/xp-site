...
@section('content')
    ...
    <div class="card pl-3 pr-3 pb-3 pt-1 certificate">
        <div class="div-btns">
            <button class="btn btn-primary btn-sm js_edit_btn">
        ...
        <div class="card-body p-0 pt-1">
            ...
            <div class="d-none js_div_form mt-1">
                <div>
                    <input type="text" name="name_en" class="form-control mb-1 js_name_en" value="@if($certificate->language[0]->locale == 'en') {{ $certificate->language[0]->name }} @endif">
                    <div class="invalid-feedback mb-1">{{ "The name en field is required." }}</div>
                </div>

                <div>
                    <textarea name="description_en" class="form-control js_description_en" rows="4">@if($certificate->language[0]->locale == 'en'){{ $certificate->language[0]->description }}@endif</textarea>
            ...
            <div class="d-none js_div_form">
                ...
                <div>
                    <input type="text" name="name_ru" class="form-control mb-2 js_name_ru" value="@if($certificate->language[1]->locale == 'ru'){{ $certificate->language[1]->name }}@endif">
                    <div class="invalid-feedback mb-1">{{ "The name ru field is required." }}</div>
                </div>

                <div>
                    <textarea name="description_ru" class="form-control js_description_ru" rows="4">@if($certificate->language[1]->locale == 'ru'){{ $certificate->language[1]->description }}@endif</textarea>
            ...
            <div class="d-none js_div_form">
                <div>
                    <input type="text" name="name_uz" class="form-control mb-2 js_name_uz" value="@if($certificate->language[2]->locale == 'uz'){{ $certificate->language[2]->name }}@endif">
                    <div class="invalid-feedback mb-1">{{ "The name uz field is required." }}</div>
                </div>

                <div>
                    <textarea name="description_uz" class="form-control js_description_uz" rows="4">@if($certificate->language[2]->locale == 'uz'){{ $certificate->language[2]->description }}@endif</textarea>
