...
<div class="c-sidebar c-sidebar-dark c-sidebar-fixed c-sidebar-lg-show" id="sidebar">
    ...
    <ul class="c-sidebar-nav ps ps--active-y">
        ...
        <li class="c-sidebar-nav-item">
            <a class="c-sidebar-nav-link @if(Request::segment(2) == 'product-category') active @endif" href="{{ route('product-category.index') }}">
                <svg class="c-sidebar-nav-icon">
        ...
        <li class="c-sidebar-nav-item">
            <a class="c-sidebar-nav-link @if(Request::segment(2) == 'product') active @endif" href="{{ route('product.index') }}">
                <svg class="c-sidebar-nav-icon">
                    <use xlink:href="{{ asset('admin/icons/sprites/free.svg#cil-user') }}"></use>
                </svg>
                Products
        ...
        <li class="c-sidebar-nav-item">
            <a class="c-sidebar-nav-link @if(Request::segment(2) == 'user-task') active @endif" href="">
                <svg class="c-sidebar-nav-icon">
