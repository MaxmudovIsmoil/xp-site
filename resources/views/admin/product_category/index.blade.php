...
@section('content')
        ...
        <div class="card">
            <div class="card-body p-0">
                ...
                <button data-url="{{ route('product-category.store') }}" class="btn btn-primary btn-sm add-user-btn js_add_btn">
                                ...
                                <td class="text-right">
                                    <div class="d-flex" style="float: right;">
                                        <a href="javascript:void(0);" class="text-primary mr-5 js_edit_btn"
                                            data-one_product_category_url="{{ route('product-category.getOne', $product_category->id) }}"
                                            data-update_url="{{ route('product-category.update', $product_category->id) }}" title="Edit">
                                        ...
                                        <a class="text-danger js_delete_btn" href="javascript:void(0);" data-toggle="modal"
                                            ...
                                            data-url="{{ route('product-category.destroy', $product_category->id) }}" title="Delete">
