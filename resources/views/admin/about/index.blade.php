    ...
    <div class="card pl-3 pr-3 pb-3 pt-1 about">
        ...
        <div class="card-body p-0 pt-1">
            ...
            <div class="d-none js_div_form mt-0">
                <textarea name="description_en" class="form-control js_description_en js_text_editer" rows="8">@if($about->language[0]->locale == 'en'){{ $about->language[0]->description }}@endif</textarea>
                <div class="invalid-feedback mb-1">{{ "The description en field is required." }}</div>
            </div>
            <hr>

            <span>Ru:</span>
            @isset($about->language[1]->locale)
            ...
            <div class="d-none js_div_form mt-0">
                <textarea name="description_ru" class="form-control js_description_ru js_text_editer" rows="8">@if($about->language[1]->locale == 'ru'){{ $about->language[1]->description }}@endif</textarea>
            ...
            <div class="d-none js_div_form mt-0">
                <textarea name="description_uz" class="form-control js_description_uz js_text_editer" rows="8">@if($about->language[2]->locale == 'uz'){{ $about->language[2]->description }}@endif</textarea>
